...
class MovimentacaoController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'origem' => 'required|in:nota_fiscal,manual,transferencia,inventario,venda_assistida,cancelamento_venda_assistida,cancelamento_item',
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            ...
            'origem' => 'sometimes|required|in:nota_fiscal,manual,transferencia,inventario,venda_assistida,cancelamento_venda_assistida,cancelamento_item',
            'id_referencia' => 'nullable|integer',
